...
//La se contente de transmettre la demande de l’utilisateur à la classe Connexion pour la connexion à la base de données.
	...
	//méthode d'instance servant de méthodes d'appel aux actions
		...
		*/
		...
		private void valider() {
			...
			//connexion
			try {
				boolean valide = connexionDb.connexionUtilisateur(leNom, leMotDePasse);
				if (valide) { 
		            //connexion réuissie
