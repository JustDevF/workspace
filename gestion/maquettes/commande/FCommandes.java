...
public class FCommandes extends JDialog {
	...
	/**
	 *  Création d'une fenêtre dialogue
	 */
	//constructeur
	public FCommandes() {
		...
		//Panneau d'information situé en haut à nord du panneau central
		...
		//Panneau des actions situé à l'intérieur du panneau valeur
		panel = new JPanel();
		...
		//Champs mode de règlement
		lblReglement = new JLabel("Mode de règlement");
