...
public class PManagerieAjouterChien extends JPanel {
	...
	public PManagerieAjouterChien() {
		...
		lblAjoutchat = new JLabel("AjoutChien");
		lblAjoutchat.setIcon(new ImageIcon(PManagerieAjouterChien.class.getResource("/images/chien.png")));
		...
		btnAccueil.setIcon(new ImageIcon(PMenagerieAjouterChat.class
		...
		//Panneau central au centre du panneau principal
				...
				//Champs code postal 
				lblCodepostal = new JLabel("TypeEducation");
				...
				gbc_lblEnvironnement.insets = new Insets(0, 0, 0, 5);
				gbc_lblEnvironnement.gridx = 2;
				gbc_lblEnvironnement.gridy = 2;
				panel_etatCivil.add(lblEnvironnement, gbc_lblEnvironnement);
				...
				gbc_txtEnvironnement.gridx = 3;
				gbc_txtEnvironnement.gridy = 2;
				panel_etatCivil.add(txtEnvironnement, gbc_txtEnvironnement);
	...
	public void sauvegarder() {		
		...
		String typeEducation = txtTypeEducation.getText();
		String environnement = txtEnvironnement.getText();
			
		Animal chienAllemand = new Chien (espece, nom, race, typeEducation, environnement);
		
		//utilisatio nde la même instance pour rajouter des animaux	
